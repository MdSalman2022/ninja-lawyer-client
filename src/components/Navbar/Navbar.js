            ...
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        ...
                        <Link to="/login" className={`cursor-pointer btn bg-transparent border-white text-white hover:bg-white hover:text-base-100 `}>Login</Link>
                    </ul>
                    </div>
                    <Link to="/"><img className='w-32' src="https://i.ibb.co/nPDh7PX/ninja-lawyer-red.png" alt="" /></Link>
                </div>
                ...
                <div className="navbar-end hidden lg:flex">
                    <ul className="menu menu-horizontal px-1 space-x-2">
                        ...
                        <li onClick={()=>setNav('ask')} ><a><span className={`cursor-pointer transition-all duration-300 hover:text-accent font-semibold ${nav === 'ask' && 'text-accent'}`}>Ask Lawyer</span></a></li>
                        <li onClick={()=>setNav('property')} ><a><span className={`cursor-pointer transition-all duration-300 hover:text-accent font-semibold ${nav === 'property' && 'text-accent'}`}>Property</span></a></li>
                        <Link to="/login" onClick={()=>setNav('property')} ><span className={`cursor-pointer btn bg-transparent border-white text-white hover:bg-white hover:text-base-100 `}>Login</span></Link>
                    </ul>
                </div>
            </div>

                    ...
                    <div>
                        <div className="flex flex-col md:grid grid-cols-5 justify-items-center content-center place-content-center place-items-center">
                            <div className='col-span-1'>
                                <Player className='w-80 lg:w-[300px]' autoplay loop src="https://assets7.lottiefiles.com/packages/lf20_rdkrsaca.json"></Player>
                            </div> 
                            <div className='col-span-3'>
                                <Player className='w-80 lg:w-[700px]  ' autoplay loop src="https://assets9.lottiefiles.com/packages/lf20_qwATcU.json"> </Player>
                            </div>
                            <div className='col-span-1'>
                                <Player className='w-80 lg:w-[300px]' autoplay loop src="https://assets7.lottiefiles.com/packages/lf20_3adn32pc.json"> </Player>
                            </div>
                        </div>
                    </div>
                    <div>

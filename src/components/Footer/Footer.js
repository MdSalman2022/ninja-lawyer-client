        ...
        <footer className="p-4 sm:p-6">
          ...
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 className="mb-6 text-sm font-semibold text-base-100 uppercase dark:text-primary">
                  Resources
                </h2>
                <ul className="text-base-100 dark:text-gray-400">
                  <li className="mb-4">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-base-100 sm:text-center dark:text-gray-400">
              © 2023{" "}
              <a href="#" className="hover:underline">
                NinjaLawyers (ltd)
              </a>

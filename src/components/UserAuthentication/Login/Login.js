    ...
    <div>
      <section className="bg-primary dark:bg-base-100">
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                ...
                <Link to="/"><img className={`w-44 mb-6 ${!darkmode && 'hidden'}`} src="https://i.ibb.co/nPDh7PX/ninja-lawyer-red.png" alt="" /></Link>
                <Link to="/"><img className={`w-44 mb-6 ${darkmode && 'hidden'}`} src="https://i.ibb.co/smWpwrC/png.png" alt="" /></Link>

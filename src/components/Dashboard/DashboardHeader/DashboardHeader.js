        ...
        <div className='py-3'>
            <div className={`flex items-center md:justify-between`}>
                ...
                <div className='flex gap-5 text-center text-black md:text-lg'>
                    ...
                    {user.displayName === 'lawyer' && <Link className='hover:text-accent' to='/practice-areas'>Practice Areas</Link>}
                    {user.displayName === 'lawyer' && <Link className='hover:text-accent' to='/check-meeting'>Check Meeting</Link>}

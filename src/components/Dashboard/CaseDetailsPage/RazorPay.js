  ...
  return (
    <div className='flex flex-col items-center justify-center h-fit'>
      ...
      <div className="flex items-center justify-center">
        {!orderData.id &&
          <button className="primary-outline-btn col-span-5 flex justify-start w-fit rounded-r-none border-r-none" onClick={() => displayRazorpay()}>Accept</button>}
        {!orderData.id &&
